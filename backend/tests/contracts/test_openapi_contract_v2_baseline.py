...
def test_v2_paths_are_declared() -> None:
    ...
    for path in (
        ...
        "/v2/validation-cli-auth/sessions/{sessionId}/revoke:",
...
def test_v2_operation_ids_are_declared() -> None:
    ...
    for operation_id in (
        ...
        "startValidationCliDeviceAuthV2",
        "approveValidationCliDeviceAuthV2",
        "pollValidationCliDeviceTokenV2",
        "whoamiValidationCliAuthV2",
        "introspectValidationCliTokenV2",
        "listValidationCliSessionsV2",
        "revokeValidationCliSessionV2",
